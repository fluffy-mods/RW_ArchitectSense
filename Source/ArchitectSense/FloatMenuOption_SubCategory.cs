...
namespace ArchitectSense
{
    ...
    {
        static readonly PropertyInfo Designator_Build_DoToolTip_PropertyInfo = typeof (Designator_Build).GetProperty ("DoTooltip", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.FlattenHierarchy);
        ...
        public bool DoGUI_BG(Rect rect) {
            ...
            Widgets.DrawTextureFitted (new Rect (rect), badTex, gizmo.iconDrawScale * 0.85f, gizmo.iconProportions, gizmo.iconTexCoords);
        ...
        public bool DoGUI_Label(Rect rect) {
            ...
            if (!gizmo.HighlightTag.NullOrEmpty () && (Find.WindowStack.FloatMenu == null || !Find.WindowStack.FloatMenu.windowRect.Overlaps (rect))) {
